...
### News
*   `GET /news` - Get All News (Supports pagination: `?page=1&limit=10`)
*   `GET /news/:id` - Get News Article by ID
*   `POST /news` - Create News Article (Protected)
*   `PATCH /news/:id` - Update News Article (Protected)
*   `DELETE /news/:id` - Delete News Article (Protected)
*   `POST /news/:id/comments` - Add Comment (Protected)
*   `DELETE /news/:id/comments/:commentId` - Delete Comment (Protected)
